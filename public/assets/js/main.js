(function ($) {
	...
	$('.testimonial__carousel--2').owlCarousel({
		...
		autoplayTimeout:5000,
		smartSpeed: 800,
		navText:['<i classNamefar fa-long-arrow-left"></i>','<i classNamefar fa-long-arrow-right"></i>'],
		nav: true,
		dots: false,
	});
	...
	CartPlusMinus.prepend('<div classNamedec qtybutton">-</div>');
	CartPlusMinus.append('<div classNameinc qtybutton">+</div>');
